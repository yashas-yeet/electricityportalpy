...
from views.dialogs import ChangePasswordDialog, ResetPasswordDialog, UpdateUserDialog
...
class AdminView(ctk.CTkFrame):
    ...
    def create_manage_users_tab(self, tab):
        ...
        # --- FIX: Bind to the correct function ---
        self.user_search_entry.bind("<KeyRelease>", self.filter_user_list_event)
        
        export_button = ctk.CTkButton(search_frame, text="📄 Export to Excel", width=120,
        ...
        remove_button = ctk.CTkButton(button_frame, text="🗑️ Remove Selected", command=self.remove_user, font=font_normal)
        remove_button.pack(side="left", padx=10, pady=5)
        
        update_button = ctk.CTkButton(button_frame, text="✏️ Update Info", command=self.open_update_user_dialog, font=font_normal)
        update_button.pack(side="left", padx=10, pady=5)
        
        reset_pass_button = ctk.CTkButton(button_frame, text="🔑 Reset Password", command=self.open_reset_password_dialog, font=font_normal)
        reset_pass_button.pack(side="left", padx=10, pady=5)
        
        sort_usage_button = ctk.CTkButton(button_frame, text="Sort by Usage 📊", width=150,
    ...
    def create_view_consumption_tab(self, tab):
        ...
        self.import_button = ctk.CTkButton(edit_frame, text="📥 Import CSV", width=140, font=font_normal,
                                          command=self.import_consumption_csv)
        self.import_button.pack(side="left", padx=10)
        
        self.export_cons_button = ctk.CTkButton(edit_frame, text="📤 Export Excel", width=140, font=font_normal,
                                               command=self.export_consumption_to_excel)
        self.export_cons_button.pack(side="left", padx=10)
        
        self.delete_usage_button = ctk.CTkButton(edit_frame, text="🗑️ Delete Selected", width=140, font=font_normal,
    ...
    def create_billing_tab(self, tab):
        ...
        self.view_bill_button = ctk.CTkButton(top_bill_frame, text="👁️ View Full Bill", 
    ...
    def create_compare_tab(self, tab):
        ...
        compare_button = ctk.CTkButton(compare_controls_frame, text="📈 Generate Comparison",
    ...
    def create_grievance_tab(self, tab):
        ...
        self.grievance_status_filter = ctk.CTkOptionMenu(grievance_controls_frame, values=["All", "Pending", "Answered", "Resolved"],
        ...
        self.grievance_send_button = ctk.CTkButton(reply_button_frame, text="✉️ Send Reply", 
                                                    font=font_normal, command=self.send_grievance_reply)
        self.grievance_send_button.pack(side="left", padx=10)
        
        self.grievance_resolve_button = ctk.CTkButton(reply_button_frame, text="✔️ Mark as Resolved", 
    ...
    def create_log_tab(self, tab):
        ...
        refresh_button = ctk.CTkButton(log_filter_frame, text="🔄 Refresh Log", command=self.refresh_log_tab, font=font_normal)
    ...
    # --- FIX: Renamed function, removed unused search_users and clear_user_search ---
    ...
    def send_grievance_reply(self):
        ...
        try:
            ...
            db_query("UPDATE grievance_tickets SET status = 'Answered', updated_at = ? WHERE id = ?", (timestamp, selected_item_id))
